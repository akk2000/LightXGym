...
// get class applied id
    ...
    if(isset($_POST['order_btn'])){
       ...
       $shippingAddress = $_POST['shippingAddress'];
        $Updatequery = "INSERT INTO item_order(userId,itemId,itemtitle,unit,price,shippingaddresss) VALUES($userId,$itemId,'$itemTitle',$unit,'$price','$shippingAddress')";
                ...
                <form action="order.php" method="POST">
                    ...
                    ?>                  
                            <div class="form-group">
                                <input type="text" value="<?php echo $itemId ?>" name="itemId"><br>
                                <input type="text" value="<?php echo $userId ?>" name="userId"><br>
